        ...
        if epoch in check_epochs:
            ...
            with torch.no_grad():
                for data in testloader:
                    ...
                    batch_results = pd.DataFrame({"predicted": predicted.cpu(), "lables": labels.cpu()})
            ...
            display(confusion_matrix(results.predicted, results.lables))

display(confusion_matrix(results.predicted, results.lables)/1000)
