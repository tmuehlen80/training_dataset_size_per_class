...
n_repeat = 20
subset_sizes = np.arange(1000, 5000 + 1, 500).tolist()
#subset_sizes = np.arange(1000, 4000 + 1, 1000).tolist()
#subset_sizes
...
results.to_csv("Cifar10_acc_subsets_thomas_batch_size_512_20230624.csv", index=False)
